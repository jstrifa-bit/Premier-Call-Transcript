  ...
  try {
    const resp = await fetch("https://api.anthropic.com/v1/messages", {
      ...
      body: JSON.stringify({
        model,
        max_tokens: 2000,
        // temperature: 0 makes routing deterministic on the same transcript.
        // The analyze step is a clinical decision, not a creative task -
        // same input should produce the same disposition every time.
        temperature: 0,
        system,
