...
SOP RECOMMENDATIONS:
A rule fires ONLY when its trigger condition is satisfied by an EXPLICIT, NON-NULL flag value. NEVER treat a null flag as "false" or "absent" - if the transcript did not address the flag, the rule does NOT fire. A routing recommendation generated from missing data is more dangerous than no recommendation at all.
